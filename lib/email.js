...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6281310165338">WhatsApp</a></span></span>
            <span style="display: block;"><br>Regards,<br>Kallpolo</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"Kallpolo" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - KpAPIs`,
        html: inboxGmail,
      };
